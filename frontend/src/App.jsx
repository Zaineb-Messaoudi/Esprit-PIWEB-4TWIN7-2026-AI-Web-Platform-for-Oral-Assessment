...
import RubricManagement from './Pages/teacher/RubricManagement.jsx';
...
function App() {
  ...
  // Read once at app mount — same source ProtectedRoute uses
              ...
              <Routes>
                ...
                <Route element={<ProtectedRoute allowedRoles={["student"]} />}>
                  <Route path="/StudydDashboard" element={<StudyDashboard />}>
                    ...
                    <Route path="reports/:evaluationId" element={<StudentReport />} />

                    {/* ── Forum ── */}
                    <Route path="forum" element={<DiscussionForum role="student" currentUserId={currentUserId} />} />
                ...
                <Route element={<ProtectedRoute allowedRoles={["instructor"]} />}>
                  <Route path="/teacherdashboard" element={<TeacherDashboard />}>
                    ...
                    <Route path="submissions/:id/evaluate" element={<FeedbackReport />} />
                    <Route path="evaluations/:evaluationId/edit" element={<FeedbackReport />} />
                    ...
                    {/* ── Forum ── */}
                    <Route path="forums" element={<DiscussionForum role="instructor" currentUserId={currentUserId} />} />
                ...
                <Route element={<ProtectedRoute allowedRoles={["admin"]} />}>
                  <Route path="/AdminDashboard" element={<AdminDashboard />}>
                    ...
                    <Route path="content_moderation" element={<DiscussionForum role="admin" currentUserId={currentUserId} />} />
