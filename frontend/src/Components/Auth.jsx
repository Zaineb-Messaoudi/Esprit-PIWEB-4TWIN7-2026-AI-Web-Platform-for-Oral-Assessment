    ...
    return (
      <div className="relative group">
        ...
        <select
          ...
          className={`w-full pl-10 pr-4 py-3 rounded-lg backdrop-blur-sm transition-all duration-300
          ${isDark
              ? "bg-gray-800/50 border border-gray-600/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 hover:border-red-400/30"
              : "bg-white/80 border border-gray-300 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500/40 focus:border-red-500/40 hover:border-red-400/40"
          }`}
        >
  ...
  return (
    <div className="relative group">
      ...
      <input
        ...
        onFocus={() => setIsFocused(true)}
        onBlur={() => setIsFocused(false)}
        className={`w-full pl-10 pr-12 py-3 rounded-lg backdrop-blur-sm transition-all duration-300
          ${isDark
    ...
    >
      ...
      <div className="z-10 relative w-full max-w-md">
        ...
        ${theme === "dark"
            ...
            : "bg-zinc-50/80 border border-gray-200"
        }`}>
          <div className={`flex rounded-t-2xl overflow-hidden transition-colors duration-500
          ${theme === "dark" ? "bg-gray-800/50" : "bg-gray-100"}
          `}>
            <button onClick={() => !isSignUp && handleToggle()} className={`flex-1 py-4 px-6 ${!isSignUp ? 'bg-gradient-to-r from-red-500 to-red-600 text-white' : theme === "dark" ? 'text-gray-400' : 'text-gray-500'}`}> <LogIn className="w-4 h-4" /> Sign In </button>
            <button onClick={() => isSignUp && handleToggle()} className={`flex-1 py-4 px-6 ${isSignUp ? 'bg-gradient-to-r from-red-500 to-red-600 text-white' : theme === "dark" ? 'text-gray-400' : 'text-gray-500'}`}> <UserPlus className="w-4 h-4" /> Sign Up </button>
          </div>
          <div className="p-8">
